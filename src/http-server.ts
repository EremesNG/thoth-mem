...
import {
  ...
  handleCommunitiesStatus,
  handleContext,
  handleCreateObservation,
  handleDropCommunities,
  handleDeleteProject,
  ...
  handleProjectGraph,
  handleProjectCommunities,
  handleProjectSummary,
  handleProjectTopicKeys,
  handlePreviewCommunities,
  handlePruneGraph,
  handleRebuildCommunities,
  handleRebuildGraph,
  handleRebuildIndex,
  handleSavePrompt,
...
const ROUTES: RouteDefinition[] = [
  ...
  { method: 'POST', pattern: '/communities/rebuild', handler: handleRebuildCommunities },
  { method: 'POST', pattern: '/communities/preview', handler: handlePreviewCommunities },
  { method: 'GET', pattern: '/communities/status', handler: handleCommunitiesStatus },
  { method: 'DELETE', pattern: '/communities', handler: handleDropCommunities },
  ...
  { method: 'GET', pattern: '/projects/:project/communities', handler: handleProjectCommunities },
