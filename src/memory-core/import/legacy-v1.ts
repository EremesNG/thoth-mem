...
export interface LegacyImportReport {
  schema: 'thoth-mem.import.v2';
  reportVersion: 2; sourceSchemaVersion: 'legacy-v1' | 'unknown'; targetSchemaVersion: 2; startedAt: string; finishedAt: string; committed: boolean;
