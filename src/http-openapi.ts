    ...
    components: {
      ...
      schemas: {
        ...
        SemanticAtlasEdge: {
          ...
          required: ['id', 'source_id', 'target_id', 'kind', 'relation', 'label', 'summary', 'weight', 'evidence_count'],
        },
        SemanticAtlasPageResponse: {
          ...
          required: ['level', 'generation', 'nodes', 'edges', 'counts', 'coverage', 'facets', 'navigation', 'continuation', 'truncated', 'health'],
        },
        VizSliceResponse: {
          type: 'object',
          properties: {
