...
- Normal motion is a bounded low-alpha idle reheat, not an unbounded animation loop. Pause, reduced motion, hidden documents, renderer failure, supersession, and destroy must cancel every timer and stop the simulation.
